...
@pytest.fixture
def mock_logger():
    with patch('sudo_sql.pipeline.inference.logger') as mock_log:
        yield mock_log

@pytest.fixture
def mock_openai_provider():
    with patch('sudo_sql.pipeline.inference.OpenAIProvider') as mock_provider_cls:
...
def mock_data_loader():
    with patch('sudo_sql.pipeline.base.get_data_loader') as mock_get_loader:
...
@patch('sudo_sql.pipeline.inference.datetime')
